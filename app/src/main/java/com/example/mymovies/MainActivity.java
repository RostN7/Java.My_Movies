...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<JSONObject> {
    ...
    private static int LOADER_ID = 111;
    ...
    private void setMethodOfSort(boolean isTopRated) {
        if (isTopRated) {
            ...
            textViewPopularity.setTextColor(getResources().getColor(R.color.design_default_color_primary_dark));
            methodOfSort = NetworkUtils.TOP_RATED;
        } else {
            methodOfSort = NetworkUtils.POPULARITY;
            textViewTopRated.setTextColor(getResources().getColor(R.color.design_default_color_primary_dark));
